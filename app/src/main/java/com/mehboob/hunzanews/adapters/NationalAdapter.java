...
public class NationalAdapter extends RecyclerView.Adapter<NationalAdapter.CategoryHolder> {
    private List<CategoryItem> newsList;
    private Context context;
    private NationalAdapter.OnItemClickListener onItemClickListener;
    int code;
    ...
    public void setOnItemClickListener(NationalAdapter.OnItemClickListener listener) {
        this.onItemClickListener = listener;
    }


    public NationalAdapter(List<CategoryItem> newsList, Context context,int code) {
