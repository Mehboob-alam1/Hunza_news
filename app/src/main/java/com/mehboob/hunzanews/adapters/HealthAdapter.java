...
public class HealthAdapter extends RecyclerView.Adapter<HealthAdapter.CategoryHolder> {
    private List<CategoryItem> newsList;
    private Context context;
    private HealthAdapter.OnItemClickListener onItemClickListener;
    int code;
    ...
    public HealthAdapter(List<CategoryItem> newsList, Context context,int code) {
